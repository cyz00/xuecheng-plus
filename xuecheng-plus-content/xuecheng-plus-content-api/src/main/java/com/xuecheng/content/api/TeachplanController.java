...
public class TeachplanController {
    ...
    @ApiOperation(value = "解除视频绑定")
    @DeleteMapping("/teachplan/association/media/{teachPlanId}/{mediaId}")
    public void removeassociateMedia(@PathVariable Long teachPlanId,@PathVariable String mediaId){
        teachplanService.removeassociateMedia(teachPlanId,mediaId);
    }
